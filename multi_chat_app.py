...
def load_csv(uploaded_file):
    ...
    # Return each row as a concatenated string of all columns
...
def generate_embeddings(documents):
    texts = [doc for doc in documents]  # Assuming each document is a string now
...
if uploaded_files:
    ...
    if documents:  # Check if documents are loaded
        ...
        st.write("No documents loaded. Please upload valid document files.")
